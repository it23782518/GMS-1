    ...
    <div className="flex justify-between items-center mb-4">
      ...
      <div className="flex space-x-2">
        ...
        <button 
          ...
          disabled={refreshing}
          className="p-2 rounded bg-cyan-500 text-white hover:bg-cyan-600 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
